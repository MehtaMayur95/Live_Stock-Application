package com.example.stock_watch_2k19;
...
public class StockAdapter extends RecyclerView.Adapter<StockViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StockViewHolder stockViewHolder, int position) {
        ...
        stockViewHolder.stockValue.setText(String.format("%f",stockData.getStockValue()));
        stockViewHolder.stockChange.setText(String.format("%f",stockData.getStockChange()));
        String stockDiff = (String.format("%f",stockData.getStockChangePercent()));
